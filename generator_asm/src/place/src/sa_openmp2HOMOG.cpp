...
int main(int argc, char** argv) {
    ...
    //Marca quais instancias tiveram roteamento com sucesso
    ...
    for (int k = 0; k < 1; ++k) {       
        ...
        routing(gridSize, edges, nodes, edge_list, edges_cost[k], positionsXFlat, positionsYFlat, NGRIDS, k, successfulRoutings[k]);

        int minBuff = buffer(g, activeFifos[k], manh, edges_cost[k], buffers[k], successfulRoutings[k]);
        //cout << minBuff << " ";
